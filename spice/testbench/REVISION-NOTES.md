...
| Bench | Status | Notes |
|---|---|---|
| tb_preamp_dc | RE-BASELINED | Matches melange-circuits' deck < 1 mV every node (14.5 V, BF 1434). |
...
| tb_preamp_ac | RE-BASELINED | 15.54 dB @1 kHz (R_ldr 12K, loaded out); HF −3 dB 16.79 kHz (triple-confirmed: melange 16.7, derivation 17.1); mild LF rise to 16.4 dB @31 Hz (stage-2 zero/pole + loop-gain shaping — real physics, not a defect). |
