...
const K_SUB_DEFAULT: [[f64; M]; M] = [
    [
        -1.39229410510403522e4,
        -1.40023599404792349e4,
        -3.92294115104035200e3,
        9.99999990000000071e3,
    ],
    [
        7.30847765580847408e0,
        -7.94188894388821609e1,
        7.30847765580847408e0,
        0.00000000000000000e0,
    ],
    [
    ...
    [
        1.39302495286961603e4,
        1.39229410510403541e4,
        3.93024962869616047e3,
        -9.99999990000000071e3,
    ],
];
...
pub const DC_OP: [f64; N] = [
    4.26480458363572357e0,
    0.00000000000000000e0,
    1.24642300965575981e0,
    2.75561285973736503e0,
    6.66518981651571640e-1,
    1.50000000000000000e1,
    -2.28408414614134341e-3,
];

/// DC operating point: nonlinear device currents at bias point
pub const DC_NL_I: [f64; M] = [
    7.72841164985201955e-5,
    3.86420577732601037e-7,
    2.20372764986731876e-3,
    1.10186382445765932e-5,
];
    ...
    if !converged {
        ...
        for _iter in 0..MAX_ITER {
            ...
            if !singular {
                ...
                {
                    let dev_alpha = alpha[0].min(alpha[1]);
                    alpha[0] = dev_alpha;
                    alpha[1] = dev_alpha;
                }
                {
                    let dev_alpha = alpha[2].min(alpha[3]);
                    alpha[2] = dev_alpha;
                    alpha[3] = dev_alpha;
                }
