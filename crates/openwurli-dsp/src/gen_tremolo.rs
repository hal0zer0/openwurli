...
const A_DEFAULT: [[f64; N]; N] = [
    [
        2.13825129466821001e-2,
        -2.11679999999999993e-2,
        0.00000000000000000e0,
        -1.47058823529411773e-6,
        0.00000000000000000e0,
        -2.12765957446808509e-4,
...
const A_BE_DEFAULT: [[f64; N]; N] = [
    [
        1.07984247466821025e-2,
        -1.05839999999999997e-2,
        0.00000000000000000e0,
        -1.47058823529411773e-6,
        0.00000000000000000e0,
        -2.12765957446808509e-4,
...
const S_DEFAULT: [[f64; N]; N] = [
    [
        3.93058606711799348e3,
        3.92317680772797803e3,
        3.92263181745426300e3,
        5.45504790431481479e-1,
        0.00000000000000000e0,
        0.00000000000000000e0,
        8.36294907897445094e-1,
    ],
    [
        3.92317680772797848e3,
        3.96293358266485984e3,
        3.96238306932884961e3,
        5.47751348733027110e-1,
        0.00000000000000000e0,
        0.00000000000000000e0,
        8.34718469729356816e-1,
    ],
    [
        3.92263181745426346e3,
        3.96238306932884916e3,
        4.00906718838295410e3,
        5.50956291744411408e-1,
        0.00000000000000000e0,
        0.00000000000000000e0,
        8.34602514351970748e-1,
    ],
    [
        5.45504790431481701e-1,
        5.47751348733027221e-1,
        5.50956291744411519e-1,
        4.72346318503277658e1,
        0.00000000000000000e0,
        0.00000000000000000e0,
        1.16064849027974802e-4,
    ],
    [
        0.00000000000000000e0,
        0.00000000000000000e0,
    ...
    [
        8.36294907897445317e-1,
        8.34718469729356927e-1,
        8.34602514351970970e-1,
        1.16064849027974802e-4,
        0.00000000000000000e0,
        1.00000000000000000e0,
        -3.48308716601180237e-5,
    ],
];
...
const K_DEFAULT: [[f64; M]; M] = [
    [
        -1.39226317174542637e4,
        -1.40090670883829553e4,
        -3.92263181745426346e3,
        9.99999990000000071e3,
    ],
    [
        7.95424966373002462e0,
        -8.64353709286910998e1,
        7.95424966373002462e0,
        0.00000000000000000e0,
    ],
    [
...
const S_BE_DEFAULT: [[f64; N]; N] = [
    [
        3.93312277382122966e3,
        3.91832281641642976e3,
        3.91723441146750656e3,
        1.09046066526842456e0,
        0.00000000000000000e0,
        0.00000000000000000e0,
        8.36834632727921135e-1,
    ],
    [
        3.91832281641643021e3,
        3.99770525788678106e3,
        3.99659480080244657e3,
        1.09942848799176329e0,
        0.00000000000000000e0,
        0.00000000000000000e0,
        8.33685705620517026e-1,
    ],
    [
        3.91723441146750747e3,
        3.99659480080244703e3,
        4.08994064305272514e3,
        1.11224358723898265e0,
        0.00000000000000000e0,
        0.00000000000000000e0,
        8.33454130099469670e-1,
    ],
    [
        1.09046066526842500e0,
        1.09942848799176374e0,
        1.11224358723898309e0,
        9.44562950249505633e1,
        0.00000000000000000e0,
        0.00000000000000000e0,
        2.32012907503920210e-4,
    ],
    [
        0.00000000000000000e0,
        0.00000000000000000e0,
    ...
    [
        8.36834632727921135e-1,
        8.33685705620516915e-1,
        8.33454130099469559e-1,
        2.32012907503920129e-4,
        0.00000000000000000e0,
        1.00000000000000000e0,
        -3.47160365898040196e-5,
    ],
];
...
const K_BE_DEFAULT: [[f64; M]; M] = [
    [
        -1.39172343114675077e4,
        -1.40899405430527258e4,
        -3.91723441146750747e3,
        9.99999990000000071e3,
    ],
    [
        1.58883623537221865e1,
        -1.72706231585218575e2,
        1.58883623537221865e1,
        0.00000000000000000e0,
    ],
    [
...
pub fn process_sample(input: f64, state: &mut CircuitState) -> [f64; NUM_OUTPUTS] {
    ...
    for iter in 0..MAX_ITER {
        ...
        {
            // BJT 0
            let vbe = v_nl[0] * DEVICE_0_SIGN;
            let vbc = v_nl[1] * DEVICE_0_SIGN;
            ...
            i_nl[0] = ic * DEVICE_0_SIGN;
            i_nl[1] = ib * DEVICE_0_SIGN;
            j_dev[0 * M + 0] = jac[0];
            j_dev[0 * M + 1] = jac[1];
            j_dev[1 * M + 0] = jac[2];
            j_dev[1 * M + 1] = jac[3];
        ...
        {
            // BJT 1
            let vbe = v_nl[2] * DEVICE_1_SIGN;
            let vbc = v_nl[3] * DEVICE_1_SIGN;
            let (ic, ib, jac) = bjt_evaluate(
                vbe,
                vbc,
                state.device_1_is,
            ...
            i_nl[2] = ic * DEVICE_1_SIGN;
            i_nl[3] = ib * DEVICE_1_SIGN;
            j_dev[2 * M + 2] = jac[0];
            j_dev[2 * M + 3] = jac[1];
            j_dev[3 * M + 2] = jac[2];
            j_dev[3 * M + 3] = jac[3];
        ...
        if converged_check {
            ...
            {
                let vbe = v_nl_final[0] * DEVICE_0_SIGN;
                let vbc = v_nl_final[1] * DEVICE_0_SIGN;
            ...
            {
                let vbe = v_nl_final[2] * DEVICE_1_SIGN;
                let vbc = v_nl_final[3] * DEVICE_1_SIGN;
                let (ic, ib, _) = bjt_evaluate(
                    vbe,
                    vbc,
                    state.device_1_is,
    ...
    // Sanitize state: if NaN/inf entered, reset to DC operating point
...
mod oscillator_tests {
    ...
    fn test_self_oscillation() {
        ...
        // Settle — oscillator needs time to self-start
        for _ in 0..(sr * 2.0) as usize {
            process_sample(0.0, &mut state);
        }

        // Measure: collect 2 seconds of output
        ...
        eprintln!("Oscillator: min={min:.2}V, max={max:.2}V, swing={swing:.2}Vpp");

        // Should oscillate within supply rails (0-15V) with ~10Vpp
        assert!(swing > 1.0, "Should self-start: swing={swing:.2}V");
        assert!(max < 16.0, "Should not exceed VCC: max={max:.2}V");

        // Count zero crossings to estimate frequency
        let dc = samples.iter().sum::<f64>() / samples.len() as f64;
        let mut crossings = 0u32;
        for i in 1..samples.len() {
            if samples[i - 1] < dc && samples[i] >= dc {
                crossings += 1;
            }
        }
        let freq = crossings as f64 / 2.0;
        eprintln!("Frequency: {freq:.1} Hz (expect ~5.3 Hz)");
        assert!(
            freq > 3.0 && freq < 10.0,
            "Should be ~5.3 Hz: got {freq:.1}"
        );
        ...
        let rt = 1.0 / start.elapsed().as_secs_f64();
        eprintln!("Performance: {rt:.1}x realtime");
    }
}
