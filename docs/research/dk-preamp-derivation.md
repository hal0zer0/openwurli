...
**Note:** The tanh saturation approach described below was designed but not implemented. The deployed code (`gen_preamp.rs`, generated by melange) uses Vbe clamping to [-1.0, 0.85] to prevent exp() overflow, without explicit Ic saturation limiting.
